...
module.exports = {
  input: {
    path: "./arches_rdm_example_project/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_rdm_example_project/locale", // output path of all created files
